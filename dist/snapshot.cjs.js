    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    creamPerLP = units.parseUnits(response[0][0].toString(), 18).div(response[1][0]);
                    ...
                    return [2 /*return*/, Object.fromEntries(Array(addresses.length)
                            ...
                            return [addresses[i], parseFloat(units.formatUnits(creamLpBalance, 18))];
                        }))];
            }
        });
    });
                ...
                case 1:
                    ...
                    return [2 /*return*/, Object.fromEntries(Array(addresses.length)
                            ...
                            var supplyBalance = crCREAMBalances[i][0]
                                .mul(exchangeRate)
                                .div(units.parseUnits('1', 18));
                            var lockedBalance = units.formatUnits(supplyBalance.sub(borrowBalances[i][0]), 18);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, Object.fromEntries(Array(addresses.length)
                            ...
                            return [
                                addresses[i],
                                parseFloat(units.formatUnits(score.toString(), 18 /* decimals */))
                            ];
                        }))];
            }
        });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, Object.fromEntries(Array(addresses.length)
                            ...
                            return [
                                addresses[i],
                                parseFloat(units.formatUnits(dittoLpBalance.add(tokenBalances), options.decimals))
                            ];
                        }))];
            }
        });
...
function bdMulBn(bd, bn) {
    ...
    return bignumber.BigNumber.from(bn).mul(bdWithWEI).div(bignumber.BigNumber.from(WEI));
}
function calcNonStakedTokens(totalSupply, totalTokensStaked, totalDelegatedTokens) {
    return bignumber.BigNumber.from(totalSupply)
        ...
        .div(bignumber.BigNumber.from(WEI))
        .toNumber();
}
                            ...
                            for (var i = 0; i < result.graphAccounts.length; i++) {
                                if (result.graphAccounts[i].id == a) {
                                    if (result.graphAccounts[i].indexer != null) {
                                        ...
                                        indexerScore =
                                            indexerTokens.div(bignumber.BigNumber.from(WEI)).toNumber() *
                                                normalizationFactor;
                                    }
                                    break;
                                }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    endT = parseInt(endT);
                    amountPerMember = units.formatUnits(amountPerMember);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    balances = _a.sent();
                    return [2 /*return*/, Object.fromEntries(addresses.map(function (address, i) {
                            return [address, parseFloat(units.formatUnits(balances[i].toString()))];
                        }))];
            }
        });
    });
                    ...
                    _loop_1 = function (i) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    response = _a.sent();
                                    cvpPerLP = units.parseUnits(response[0][0].toString(), 18).div(response[1][0]);
                                    lpBalances = response.slice(2, addresses.length + 2);
                                    stakedUserInfo = response.slice(addresses.length + 2, addresses.length * 2 + 2);
                                    addresses.forEach(function (a, k) {
                                        ...
                                        votesByAddress[a] += parseFloat(units.formatUnits(cvpLpBalance, 18));
                                    });
                                    return [2 /*return*/];
                            }
                        });
